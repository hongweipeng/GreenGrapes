...
<?php endif; ?>
<div id="back-to-top" title="返回顶部" data-scroll="body" style="display: none;">
...
<script defer src="<?php $this->options->themeUrl('js/jquery.min.js'); ?>"></script>
<script defer src="<?php $this->options->themeUrl('js/bootstrap.bundle.min.js'); ?>"></script>
<script defer src="<?php $this->options->themeUrl('js/jquery.cookie.js'); ?>"></script>
<script defer src="<?php $this->options->themeUrl('js/functionall.js'); ?>"></script>
...
<?php endif; ?>
<script defer src="<?php $this->options->themeUrl('js/home.js'); ?>"></script>
<?php $this->footer(); ?>
</body>
</html>
