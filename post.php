            ...
            <article class="post-article clearfix">
                <div>
                    ...
                    <p class="post-big-info">
                        <span class="label label-skin"><i class="fa fa-fw fa-user"></i> <a href="<?php $this->author->permalink(); ?>" rel="author"><?php $this->author(); ?></a></span>
                        <span class="label label-skin"><i class="fa fa-fw fa-tags"></i> <?php $this->category(','); ?></span>
                        <span class="label label-skin"><i class="fa fa-fw fa-calendar"></i> <?php $this->date('Y-m-d'); ?></span>
                        <?php if (class_exists('TeStat_Plugin') && isset($this->options->plugins['activated']['TeStat'])): ?>
                        <span class="label label-skin"><i class="fa fa-fw fa-eye"></i> <?php $this->viewsNum(); ?> 次浏览</span>
                        <span class="label label-skin"><i class="fa fa-fw fa-thumbs-o-up"></i> <span class="like-num-show"><?php $this->likesNum(); ?></span> 次点赞</span>
                        <?php endif; ?>
                    </p>
                </div>
